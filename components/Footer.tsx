...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-blue-700 to-teal-900 text-gray-300 pt-20 pb-10 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-300 leading-relaxed text-sm">
            Providing premium medical and dental services in Harare, Zimbabwe. Your trusted healthcare partner.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4 text-sm">
            ...
            {/* Email */}
            <Link href="mailto:maranathamedical@gmail.com" target="_blank" className="flex items-center gap-3 text-gray-300 hover:text-white transition">
              <FaEnvelope className="text-white text-xl flex-shrink-0" />
              maranathamedical@gmail.com
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 border-t border-white/20 pt-6 flex flex-col md:flex-row justify-between text-sm text-gray-300">
        <p className="order-2 md:order-1 mt-4 md:mt-0">
          © {new Date().getFullYear()} Maranatha Medical & Dental Center. All rights reserved.
        </p>
